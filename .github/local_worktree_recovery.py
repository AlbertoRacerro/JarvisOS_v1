...
class InterruptedWriterRecovery:
    ...
    def inspect(self, repository_id: str, worktree_id: str) -> RecoveryInspection:
        """Return a lease CAS token plus fresh read-only Git state."""
    ...
    def recover(
        ...
        *,
        ...
        expected digest is the persisted lease generation: if anything changed
        since inspection, recovery fails closed.
        """
