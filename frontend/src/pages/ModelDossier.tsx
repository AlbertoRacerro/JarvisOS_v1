...
function Value({ label, value }: Readonly<{ label: string; value?: string | null }>) {
  return <div className="final-fusion__disclosure-row"><strong>{label}</strong><em>{value || "Unknown"}</em></div>;
}
