    ...
    <section className="engineering-data" aria-labelledby="engineering-data-title">
      ...
      <div className="engineering-data__grid">
        ...
        <aside className="engineering-data__inspector" aria-label="Selected engineering record">
          {selected ? <Inspector record={selected} mutationPending={mutationPending} onEdit={editParameter} onTransition={transitionParameter} /> : <p>Select a visible engineering record.</p>}
        </aside>
      </div>
...
function ParameterActions({ parameter, mutationPending, onEdit, onTransition }: { parameter: CanonicalParameter; mutationPending: boolean; onEdit(parameter: CanonicalParameter, edits: ParameterEditInput): void; onTransition(parameter: CanonicalParameter, action: ParameterLifecycleAction): void }) {
  ...
  return <section className="engineering-data__parameter-actions" aria-label="Canonical Parameter actions">
    ...
    {lifecycle === "active" || lifecycle === "inactive" ? <p className="engineering-data__readonly"><strong>Supersede:</strong> use the existing Parameter replacement proposal/review authority; this surface does not invent a replacement record.</p> : null}
  </section>;
}
