...
class RouterPolicyMessageRouteSmokeTests(unittest.TestCase):
    ...
    def test_a5_r2_001_italian_memory_write_intent_blocks_end_to_end(self):
        for message in (
            ...
            "ricorda questo dato per dopo",
            "ricorda di salvare questa assunzione",
            "tienilo a mente",
    ...
    def test_a5_r2_003_italian_credential_like_save_blocks_end_to_end(self):
        for message in (
            ...
            "ricorda il PIN 1234",
            "ricordati il codice di accesso abc123",
    ...
    def test_a5_r2_004_italian_false_positives_do_not_trigger_new_write_blocks(self):
        for message in (
            ...
            "questo mi ricorda il reattore",
            "questo mi ricorda il codice fiscale",
            "questo ti ricorda il brevetto?",
            "questo si ricorda male",
            "questo ci ricorda la relazione",
            "questo vi ricorda il documento",
            "questo gli ricorda il reattore",
            "questo le ricorda la relazione",
            "mi ricorda una pompa",
            "Questo mi ricorda la pompa",
            "che cos'e un brevetto?",
