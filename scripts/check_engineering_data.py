...
def check() -> None:
    ...
    for needle, label in (
        ...
        ('["Model specs", modelSpecsState, modelSpecsError]', "model-spec partial failure"),
        ('["Assumptions", assumptionsState, assumptionsError]', "assumption partial failure"),
        ('["Parameters", parametersState, parametersError]', "parameter partial failure"),
        ('["Decisions", decisionsState, decisionsError]', "decision partial failure"),
        ("unavailable.", "bounded partial-failure message"),
