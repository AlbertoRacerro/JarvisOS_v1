...
3. The complete re-derived 070 UI-FOUNDATION-1 definition is recorded in [070-ui-foundation-1.md](070-ui-foundation-1.md); the next authorized step is a separate readiness decision. No implementation is authorized while 070 remains `planned`.
...
| 070 | planned | — | UI-FOUNDATION-1 | 006, 082, 094 | Complete re-derived definition in [070-ui-foundation-1.md](070-ui-foundation-1.md); the next required step is a separate readiness decision. Closed PR #132 and its retained branch are historical input, not implementation authority. |
