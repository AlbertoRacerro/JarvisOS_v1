...
3. Specs 070 UI-FOUNDATION-1, 083 APP-SHELL-1, 084 BLUECAD-READ-MODEL-1, 085 BLUECAD-WORKBENCH-2, 086 MODEL-INSPECTION-A0, 087 LINEAGE-OVERVIEW-1, 088 RUNS-WORKBENCH-1, 035 ENGINEERING-DATA-1, 089 ANALYTICS-DOCK-1, 054 PROPOSAL-REVIEW-1, and 090 AI-THREADS-0 are merged and reconciled; the 062 operator-design session remains pending and may remain pending while Phase 5 proceeds; 091 JARVIS-SIDECAR-1 is in review in PR #281 under 091-readiness-2026-08-16.md. The maintainer-approved workstation reference continues to guide local information hierarchy, while global visual identity remains a separate independently removable lane.
