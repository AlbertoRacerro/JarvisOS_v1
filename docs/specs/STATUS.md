...
| 015 | merged | [#33](https://github.com/AlbertoRacerro/JarvisOS_v1/pull/33) | PROVIDER-GW-1 | 003 | Replace the hardcoded provider/model/route binding table with a validated, data-driven provider registry and generic OpenAI-compatible adapter while preserving safe defaults and smoke-path behavior. |
