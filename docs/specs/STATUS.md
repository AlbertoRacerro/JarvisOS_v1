...
3. Specs 070 UI-FOUNDATION-1, 083 APP-SHELL-1, 084 BLUECAD-READ-MODEL-1, and 085 BLUECAD-WORKBENCH-2 are merged and reconciled; spec 086 MODEL-INSPECTION-A0 is the next canonical planned slice. The maintainer-approved workstation reference continues to guide local information hierarchy, while global visual identity remains a separate independently removable lane.
