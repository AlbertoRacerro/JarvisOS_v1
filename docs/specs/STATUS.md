...
| 015 | merged | [#33](https://github.com/AlbertoRacerro/JarvisOS_v1/pull/33), [#43](https://github.com/AlbertoRacerro/JarvisOS_v1/pull/43) | PROVIDER-GW-2 | 015 | Complete provider-cap/fallback enforcement and correct provider usage accounting while preserving explicit routing and audit controls. |
...
| 096 | planned | — | OPERATOR-WORKBENCH-CORRECTION-0 | 054, 083, 088, 091 | First runtime slice after 095: fix sidecar/scroll/overflow containment and operator-first Runs/Review/Jarvis presentation using existing authority only; no new engineering backend semantics. |
