...
2026-08-21 and amended on 2026-08-22 after the public/canonical architecture and codebase-maintainability reviews. Item 27 is now `in_review` through implementation PR #371 after merged definition/full-spec/readiness authority; items 28–39 remain `planned` until the normal definition/full-spec/readiness lifecycle authorizes each slice. Their order
