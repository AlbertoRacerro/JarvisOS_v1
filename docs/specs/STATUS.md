...
3. Specs 070 UI-FOUNDATION-1, 083 APP-SHELL-1, 084 BLUECAD-READ-MODEL-1, and 085 BLUECAD-WORKBENCH-2 are merged and reconciled; spec 086 MODEL-INSPECTION-A0 is in review in implementation PR #244 under [the 2026-08-15 readiness decision](086-readiness-2026-08-15.md). The maintainer-approved workstation reference continues to guide local information hierarchy, while global visual identity remains a separate independently removable lane.
...
| 086 | in_review | [#244](https://github.com/AlbertoRacerro/JarvisOS_v1/pull/244) | MODEL-INSPECTION-A0 | 006, 085 | Add geometry-only viewer inspection and lifecycle hardening; all hits are session-scoped and carry no semantic record or scene-component identity. |
