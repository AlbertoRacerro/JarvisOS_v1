...
1. 097 JARVIS-ENGINEERING-ACTIONS-0 definition PR #329 and readiness PR #331 are merged; 097 is ready for exactly one bounded frontend-only deterministic-action implementation under the 2026-08-22 readiness, while 098 remains unauthorized until 097 implementation merges and is registry-reconciled.
...
| 097 | ready | — | JARVIS-ENGINEERING-ACTIONS-0 | 071b, 091, 058c | Definition PR #329 and [the 2026-08-22 readiness decision](097-readiness-2026-08-22.md) under PR #331 are merged. Authorize exactly one bounded frontend-only deterministic-action implementation over the existing 071b/058c working owner: transient typed compare-and-apply actions, deterministic blocker/safe-fix projection, complete operator-visible change preview, inert `Other`/assistant prose, atomic stale-safe apply, and existing preflight/Run separation; no backend/thread/provider/history/action-store expansion. |
