...
| 082 | ready | — | SECURE-CREDENTIAL-STORAGE-0 | 015, 018, 021, 059b, 061a | Complete implementation contract is merged through PR #214. Readiness and implementation ownership are frozen in [the 2026-08-03 readiness decision](082-readiness-2026-08-03.md); implementation branch is `impl/082-secure-credential-storage-0`, with no implementation PR yet. |
