...
3. Specs 070 UI-FOUNDATION-1, 083 APP-SHELL-1, 084 BLUECAD-READ-MODEL-1, 085 BLUECAD-WORKBENCH-2, 086 MODEL-INSPECTION-A0, and 087 LINEAGE-OVERVIEW-1 are merged and reconciled; spec 088 RUNS-WORKBENCH-1 is ready under [the 2026-08-15 readiness decision](088-readiness-2026-08-15.md) and is the current canonical implementation front. The maintainer-approved workstation reference continues to guide local information hierarchy, while global visual identity remains a separate independently removable lane.
...
| 088 | ready | — | RUNS-WORKBENCH-1 | 043, 071, 083 | Ready under [the 2026-08-15 readiness decision](088-readiness-2026-08-15.md) for one bounded frontend-only run list/detail workbench over persisted simulation-run, input/binding/result, log and artifact authority; no runner mutation, polling, analytics, backend expansion or global visual identity. |
