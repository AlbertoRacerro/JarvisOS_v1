...
3. Specs 070 UI-FOUNDATION-1, 083 APP-SHELL-1, 084 BLUECAD-READ-MODEL-1, 085 BLUECAD-WORKBENCH-2, 086 MODEL-INSPECTION-A0, 087 LINEAGE-OVERVIEW-1, and 088 RUNS-WORKBENCH-1 are merged and reconciled; the 035 ENGINEERING-DATA-1 definition is merged in PR #258 and 035 remains the next canonical planned slice pending a separate readiness decision. The maintainer-approved workstation reference continues to guide local information hierarchy, while global visual identity remains a separate independently removable lane.
