...
1. 058b VARIANT-COMPARISON-1 definition PR #352 and readiness PR #353 are merged; bounded frontend-only implementation PR #355 is now in review and remains DRAFT while its exact head is hardened and gated. No backend route/schema/store, second comparison-state owner, unit converter, provider/solver/run side effect, canonical mutation, 058d process scaffold or visual-identity work is authorized. 058d and 100 remain unauthorized until #355 merges and 058b is registry-reconciled.
