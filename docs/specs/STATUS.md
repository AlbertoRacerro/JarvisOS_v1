...
| 092 | in_review | [#303](https://github.com/AlbertoRacerro/JarvisOS_v1/pull/303) | SCENE-BINDING-0 | 005, 006, 056, 071b, 085 | Definition PR #300 and [the 2026-08-19 readiness decision](092-readiness-2026-08-19.md) under PR #301 are merged. Runtime implementation is in review under PR #303 for exporter-owned canonical `part_id` semantic keys, versioned manifest binding, stale-safe frontend resolution, and the pinned real-kernel GLB parse proof; mesh/name/order/color/bounds heuristics remain forbidden. |
