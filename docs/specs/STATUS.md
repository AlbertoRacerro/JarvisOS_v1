...
4. 100b CODEBASE-LEAN-CLEANUP-1 is the sole current runtime front and remains `ready`. Its frozen candidate set is exactly C1 from PR #406/#407; implementation authority is limited to that candidate after this 100g reconciliation is merged.
