...
3. Specs 070 UI-FOUNDATION-1, 083 APP-SHELL-1, and 084 BLUECAD-READ-MODEL-1 are merged and reconciled; spec 085 BLUECAD-WORKBENCH-2 is ready for bounded implementation under [the 2026-08-13 readiness decision](085-readiness-2026-08-13.md). The maintainer-approved workstation reference guides 085 local information hierarchy, while global visual identity remains a separate independently removable lane.
