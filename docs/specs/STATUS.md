...
2026-08-21 and amended on 2026-08-22 after the public/canonical architecture and codebase-maintainability reviews. Item 27 is now `merged` through implementation PR #371 after merged definition/full-spec/readiness authority; the maintainer visual-inspection hold is active and items 28–39 remain `planned` until that hold is explicitly released and the normal definition/full-spec/readiness lifecycle authorizes each slice. Their order
