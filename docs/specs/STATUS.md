...
1. 098 ENGINEERING-RECORD-LIFECYCLE-0 definition PR #336 and readiness PR #337 are merged; this reconciliation promotes 098 to `ready`. After this reconciliation merges, open exactly one bounded 098 runtime implementation front for the readiness-authorized Parameter-first V0. 006b remains unauthorized until 098 implementation merges and is registry-reconciled.
2. 099 REVIEW-SECRET-BOUNDARY-0 is merged through PR #306 and reconciled; the emergency security interrupt is closed.
3. Preserve merged 059a/059b, 061a/061b, 075, 076, 077, 079, 082, 094, 070, 083, 084, 085, 086, 087, 088, 035, 089, 054, 090, 091, 029, 096, 071b, 092, 058c, and 097 authority boundaries; definition-only 095 remains non-implementation authority.
...
| 015 | merged | [#33](https://github.com/AlbertoRacerro/JarvisOS_v1/pull/33), [#43](https://github.com/AlbertoRacerro/JarvisOS_v1/pull/43) | PROVIDER-GW-1/2 historical gateway spine | — | Preserve the generic provider registry/adapters, egress gating and usage-accounting foundation; no direct frontend provider access. |
...
| 098 | ready | — | ENGINEERING-RECORD-LIFECYCLE-0 | 035, 040, 050, 051, 071b | Definition PR #336 and readiness PR #337 are merged. Authorize one bounded Parameter-first V0: separate server-owned `lifecycle_state`, exact `updated_at` CAS for canonical edits/transitions, existing replacement promotion for supersede/freshness, fail-closed rejection of non-replacement authority changes with downstream dependents, lifecycle-aware current projections, and linked source revision/value/unit guards; other record kinds remain read-only. |
