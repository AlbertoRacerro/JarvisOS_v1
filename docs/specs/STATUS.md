...
2. 100a CODEBASE-LEAN-AUDIT-1 is `in_progress` under `100a-readiness-2026-08-28.md` and is the sole implementation front. It is audit-only: no cleanup, runtime rewiring, schema/API change, provider spend, or feature work.
