...
3. Specs 070 UI-FOUNDATION-1, 083 APP-SHELL-1, 084 BLUECAD-READ-MODEL-1, 085 BLUECAD-WORKBENCH-2, 086 MODEL-INSPECTION-A0, 087 LINEAGE-OVERVIEW-1, and 088 RUNS-WORKBENCH-1 are merged and reconciled; 035 ENGINEERING-DATA-1 is in review in PR #261 under [the 2026-08-15 readiness decision](035-readiness-2026-08-15.md). The maintainer-approved workstation reference continues to guide local information hierarchy, while global visual identity remains a separate independently removable lane.
...
| 035 | in_review | [#261](https://github.com/AlbertoRacerro/JarvisOS_v1/pull/261) | Domain Foundation navigator | 040, 050, 051, 083, 087, 088 | Re-derive as ENGINEERING-DATA-1: searchable engineering-record navigation integrated with the shell, lineage/freshness overview, and run surfaces rather than a flat database list. |
