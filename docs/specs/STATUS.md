...
1. 058c SCENE-SEMANTICS-A1 implementation is in review under PR #319 after merged definition #314, model-choice amendment #316, fresh readiness #317 and readiness reconciliation #318. Finish #319, merge and reconcile 058c before starting 097.
...
| 058c | in_review | [#319](https://github.com/AlbertoRacerro/JarvisOS_v1/pull/319) | Report-to-3D linking | 044, 071b, 085, 092 | Re-derived as SCENE-SEMANTICS-A1 under definition PR #314, model-choice amendment PR #316, and [the 2026-08-20 fresh readiness decision](058c-readiness-2026-08-20-fresh.md) under PR #317. Implementation is in review under #319 for the bounded schema-v3 semantic metadata, reviewed-047 companion, exact guarded execution/freshness, selected-object Geometry semantics, stable dirty-target transitions and exact source navigation, without fabricated model alternatives or formulas. |
