...
1. 006b PARAMETRIC-VARIANTS-1 definition PR #345, readiness PR #346, reconciliation PR #347 and implementation PR #348 are merged. Freshly re-derived 058b VARIANT-COMPARISON-1 is now the next authorized definition front; no 058b runtime work is authorized before its separate definition/readiness lifecycle. 058d and 100 remain unauthorized until 058b completes and is registry-reconciled.
