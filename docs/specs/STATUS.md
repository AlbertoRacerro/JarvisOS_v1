...
3. Specs 070 UI-FOUNDATION-1, 083 APP-SHELL-1, 084 BLUECAD-READ-MODEL-1, 085 BLUECAD-WORKBENCH-2, 086 MODEL-INSPECTION-A0, 087 LINEAGE-OVERVIEW-1, 088 RUNS-WORKBENCH-1, 035 ENGINEERING-DATA-1, 089 ANALYTICS-DOCK-1, 054 PROPOSAL-REVIEW-1, 090 AI-THREADS-0, 091 JARVIS-SIDECAR-1, 029 SETTINGS-1, and 096 OPERATOR-WORKBENCH-CORRECTION-0 are merged. Definition-only 095 OPERATOR-WORKSTATION-AUTHORITY-1 is merged under PR #288; 096 definition/readiness/implementation are merged under PRs #290, #291, and #293. The next operator-workstation spec front is 071b ENGINEERING-PROPERTIES-1; old 092 runtime work remains unauthorized until 071b is separately derived, readied, implemented, merged, and reconciled.
