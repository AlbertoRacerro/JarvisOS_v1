...
3. Spec 070 UI-FOUNDATION-1 is `in_review` in [implementation PR #225](https://github.com/AlbertoRacerro/JarvisOS_v1/pull/225); no 083 implementation is authorized until 070 merges and the registry is reconciled.
...
| 070 | in_review | [#225](https://github.com/AlbertoRacerro/JarvisOS_v1/pull/225) | UI-FOUNDATION-1 | 006, 082, 094 | Ready under [the 2026-08-04 readiness decision](070-readiness-2026-08-04.md) for one bounded implementation of semantic tokens, system/light/dark appearance, five shared primitives, limited migration, accessibility evidence, and the dependency-free UI foundation checker; no 083 shell work. |
