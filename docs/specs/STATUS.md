...
3. Specs 070 UI-FOUNDATION-1 and 083 APP-SHELL-1 are merged and reconciled; spec 084 BLUECAD-READ-MODEL-1 remains the next planned frontend-beta slice. The Penpot visual-identity work remains a separate independently removable lane.
