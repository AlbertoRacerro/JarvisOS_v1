...
3. Spec 070 UI-FOUNDATION-1 is merged through [implementation PR #225](https://github.com/AlbertoRacerro/JarvisOS_v1/pull/225) and the registry is reconciled; spec 083 APP-SHELL-1 is the next binding queue slice, but remains `planned` and must complete the normal definition and readiness lifecycle before implementation.
