...
3. Spec 070 UI-FOUNDATION-1 is `ready` under [the 2026-08-04 readiness decision](070-readiness-2026-08-04.md); the next authorized front is its single bounded implementation before 083.
...
| 070 | ready | — | UI-FOUNDATION-1 | 006, 082, 094 | Ready under [the 2026-08-04 readiness decision](070-readiness-2026-08-04.md) for one bounded implementation of semantic tokens, system/light/dark appearance, five shared primitives, limited migration, accessibility evidence, and the dependency-free UI foundation checker; no 083 shell work. |
