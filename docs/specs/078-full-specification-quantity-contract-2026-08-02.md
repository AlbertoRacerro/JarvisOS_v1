...
**Authority:** normative companion to `078-full-specification-2026-08-02.md`. It supplies the exact units and semantic bases required by that contract. It adds no model, parameter value, runtime authority, dependency, or migration.
...
| `co2_transfer_margin` | output | `mol/m3/s` | `co2_transfer_supply_margin` | finite, signed |
