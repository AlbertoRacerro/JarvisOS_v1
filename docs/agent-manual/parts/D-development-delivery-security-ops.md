...
Branch history contains earlier exact READ evidence for root files, `.github/**`, workflows, delivery/review/CI/continuation/codegen/recovery scripts, `docs/RUNBOOKS.md`, and data-root recovery files. This checkpoint adds direct fixed-master evidence for `scripts/local_routing_eval.py`; imports, fixture data and generated outputs are not transitively credited.
