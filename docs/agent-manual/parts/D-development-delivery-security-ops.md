...
Branch history contains earlier exact READ evidence for root files, `.github/**`, workflows, delivery/review/CI/continuation/codegen/recovery scripts, `docs/RUNBOOKS.md`, and data-root recovery files. This checkpoint restores the previously inspected `scripts/local_phase_b_soft_review_model_probe.py` row into the canonical ledger and adds direct fixed-master evidence for `scripts/local_phase_b_soft_review_probe.py`; imports, referenced schemas/holdouts/reports and generated outputs are not transitively credited.
